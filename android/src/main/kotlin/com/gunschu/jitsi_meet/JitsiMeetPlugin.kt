...
//                .setServerURL(serverURL) TODO: use serverURL after android SDK is fixed: https://github.com/jitsi/jitsi-meet/issues/5504#issue-590910863
                ...
                .setFeatureFlag(call.argument("pip.enabled") ?: false)
                .setFeatureFlag(call.argument("add-people.enabled") ?: false)
                .setFeatureFlag(call.argument("calendar.enabled") ?: false)
                .setFeatureFlag(call.argument("chat.enabled") ?: false)
                .setFeatureFlag(call.argument("invite.enabled") ?: false)
