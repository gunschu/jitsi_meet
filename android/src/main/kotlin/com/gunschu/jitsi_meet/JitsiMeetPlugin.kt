...
//                .setServerURL(serverURL) TODO: use serverURL after android SDK is fixed: https://github.com/jitsi/jitsi-meet/issues/5504#issue-590910863
                ...
                .setFeatureFlag(call.argument("pipEnabled") ?: false)
                .setFeatureFlag(call.argument("add-peopleEnabled") ?: false)
                .setFeatureFlag(call.argument("calendarEnabled") ?: false)
                .setFeatureFlag(call.argument("chatEnabled") ?: false)
                .setFeatureFlag(call.argument("inviteEnabled") ?: false)
        ...
        val defaultOptions =  JitsiMeetConferenceOptions.Builder()
                ...
                .setUserInfo(userInfo)
                .setFeatureFlag(call.argument("pipEnabled") ?: false)
                .setFeatureFlag(call.argument("addPeopleEnabled") ?: false)
                .setFeatureFlag(call.argument("calendarEnabled") ?: false)
                .setFeatureFlag(call.argument("chatEnabled") ?: false)
                .setFeatureFlag(call.argument("inviteEnabled") ?: false)
                .setWelcomePageEnabled(false)
